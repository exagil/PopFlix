...
public class MoviesTest {
    ...
    public void collectionWithMoviesShouldHaveAppropriateCount() {
        Movie firstMovie = new Movie(1, null, null, null, null, null);
        Movie secondMovie = new Movie(2, null, null, null, null, null);
        Movie thirdMovie = new Movie(3, null, null, null, null, null);
    ...
    public void shouldBeAbleToFetchMovieWithValidMovieIndex() {
        Movie firstMovie = new Movie(1, "first_movie_title", new Date(), "example_one.jpg", 10.20, "overview_first");
        Movie expectedMovie = new Movie(2, "expected_movie_title", new Date(), "example_expected.jpg", 90.10, "expected_overview");
        Movie thirdMovie = new Movie(3, "third_movie_title", new Date(), "example_three.jpg", 30.90, null);
